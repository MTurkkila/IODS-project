...
In the scaled PCA-biplot, the first principal component (PC1) explains 53.6% of the variance in the data. Let's plot that but bigger, to make interpretation easier. Let's also highlight Finland in the plot with pink star.
```{r, fig.width=10, fig.height=8}
biplot(pca_human_std, cex = c(0.8, 1), col = pca_colors, xlab = pc_lab[1], ylab = pc_lab[2])
x = pca_human_std$x["Finland",1]
y = pca_human_std$x["Finland",2]
points(x, y, pch = 8, col = "deeppink", cex = 2)
```
